...
q &= 1 - p = \frac{1}{10}
\end{align}
Using the gaussian approximation method:
\begin{align}
...
&= 1 - \pr{Z > \frac{-3}{0.9487}}\\
&= 1 - \pr{Z > -3.1622} \\
&= 1 - Q(-3.1622)\\
&= 1 - \int_{-3.1622}^{\infty}\frac{1}{\sqrt{2\pi}}\times e^{-\frac{x^2}{2}}dx\\
&= 0.000783
\end{align}
Therefore, the probability that atmost 6 out of 10 people in the random sample are right-handed is 0.000783 which is approximately 0.078\%.
\end{document}
